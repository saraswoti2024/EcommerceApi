...
class Product(models.Model):
    ...
    # code = models.CharField(max_length=50,default="EPAYTEST")
...
class Order(models.Model):
    ...
    # cart= models.ForeignKey(CartItem,on_delete=models.CASCADE,related_name='in_cart_orders')
...
#     user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name="payment_user",null= True)
...
class PaymentStatus(models.Model):
    ...
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name="status_user")
    order = models.OneToOneField(Order, on_delete=models.CASCADE, related_name="status_order")
    amount = models.DecimalField(max_digits=10, decimal_places=2)
    payment_method = models.CharField(max_length=50, choices= PAYMENT_METHODS)
    payment_at=models.DateTimeField(auto_now_add=True)

class PaymentESewa(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name="status_user_esewa")
    transaction_uuid= models.CharField(max_length=200)
    ref_id= models.CharField(max_length=50)
    product_code=models.CharField(max_length=20,)
    total_amount=models.DecimalField(max_digits=10,decimal_places=2)
    # signature=signature = models.CharField(max_length=255, null=True, blank=True)
